...
* In addition to the required [common core metadata](http://gsa-ocsit.github.com/project-open-data.github.com/schema/), work with your agency and topical experts to develop an expanded set of metadata fields that make sense for your vertical. Many already exist; explore [Schema.org](http://www.schema.org) as a starting point.
...
Ensure there is someone in your agency clearly designated and responsible for the promotion of efficient and effective data release practices across the agency.
